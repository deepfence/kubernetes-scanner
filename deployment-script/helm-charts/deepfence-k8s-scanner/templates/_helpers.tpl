...
*/}}
{{- define "deepfence-k8s-scanner.fullname" -}}
...
*/}}
{{- define "deepfence-k8s-scanner.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "deepfence-k8s-scanner.fullname" .) .Values.serviceAccount.name }}
{{- else }}
